...
<div class="buttons">
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='vehicle_xl'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} 
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='vehicle_xl'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} 
{if $bean->aclAccess("delete")}<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='vehicle_xl'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('{$APP.NTC_DELETE_CONFIRMATION}')) SUGAR.ajaxUI.submitForm(_form); return false;" type="submit" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}" id="delete_button">{/if} 
{if $bean->aclAccess("edit") && $bean->aclAccess("delete")}<input title="{$APP.LBL_DUP_MERGE}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='vehicle_xl'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='Step1'; _form.module.value='MergeRecords';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Merge" value="{$APP.LBL_DUP_MERGE}" id="merge_duplicate_button">{/if} 
...
<li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=vehicle_xl", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li>
</ul>
</li>
...
{/if} 
<span class="sugar_field" id="{$fields.rate_c.name}">{$fields.rate_c.value}</span>
{/if}
...
{if !$fields.vehicle_source.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.vehicle_source.options)}
<input type="hidden" class="sugar_field" id="{$fields.vehicle_source.name}" value="{ $fields.vehicle_source.options }">
{ $fields.vehicle_source.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.vehicle_source.name}" value="{ $fields.vehicle_source.value }">
{ $fields.vehicle_source.options[$fields.vehicle_source.value]}
{/if}
{/if}
...
{if !$fields.vehicle_cetagory.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.vehicle_cetagory.options)}
<input type="hidden" class="sugar_field" id="{$fields.vehicle_cetagory.name}" value="{ $fields.vehicle_cetagory.options }">
{ $fields.vehicle_cetagory.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.vehicle_cetagory.name}" value="{ $fields.vehicle_cetagory.value }">
{ $fields.vehicle_cetagory.options[$fields.vehicle_cetagory.value]}
{/if}
{/if}
...
{if !$fields.images_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.images_c.name}">
{if strlen($fields.images_c.value) <= 0}
<img src="" style="max-width: {if !$vardef.width}400{else}200{/if}px;" height="{if !$vardef.height}{else}50{/if}">
{else}
<img src="index.php?entryPoint=download&id={$fields.id.value}_{$fields.images_c.name}{$fields.width.value}&type={$module}" style="max-width: {if !$vardef.width}400{else}200{/if}px;" height="{if !$vardef.height}{else}50{/if}">
{/if}
</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.min_hours.name}">{$fields.min_hours.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.passenger.name}">{$fields.passenger.value}</span>
{/if}
...
{if !$fields.facilities.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.facilities.value) && ($fields.facilities.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.facilities.name}" value="{$fields.facilities.value}">
{multienum_to_array string=$fields.facilities.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.facilities.options.$item }</li>
{/foreach}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.bags.name}">{$fields.bags.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.promhourly.name}">{$fields.promhourly.value}</span>
{/if}
