...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_modified_basic) && !empty($smarty.request.date_modified_basic)}{$smarty.request.date_modified_basic}{else}{$smarty.request.range_date_modified_basic}{/if}' title=''   tabindex='-1'  size="11" class="dateRangeInput">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_modified_basic }' title=''  tabindex='-1' size="11" class="dateRangeInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_modified_basic.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_modified_basic }' title=''  tabindex='-1' size="11" class="dateRangeInput" maxlength="10">
